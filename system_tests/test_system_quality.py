...
@pytest.mark.system
@pytest.mark.recovery
def test_recovery_002_schedule_api_failure_does_not_break_system_flow(system_auth, system_timer, system_db):
...
@pytest.mark.system
@pytest.mark.recovery
def test_recovery_003_wrong_password_after_successful_registration(system_auth, system_timer, system_db):
